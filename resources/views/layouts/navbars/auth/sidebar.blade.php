<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('home') }}">
            ...
            <span class="ms-1">Livestock Marketplace & Qurban Aqiqah Services</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @if (Auth::user()->role == 'admin' || Auth::user()->role == 'seller')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('livestocks-list') ? 'active' : '' }}"
                        href="{{ route('livestocks-list') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>Livestock Shop</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="nav-link-text ms-1">Livestock Shop</span>
                    </a>
                </li>
            @endif
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link
                    href="{{ Auth::user()->role == 'admin' || Auth::user()->role == 'seller' }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
