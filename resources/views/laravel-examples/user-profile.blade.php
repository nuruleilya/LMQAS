...
<div>
    <div class="container-fluid">
        <div class="page-header min-height-300 border-radius-xl mt-4" style="background-image: url('../assets/img/regBG.png'); background-position-y: 50%;">
        </div>
                ...
                <form action="/user-profile" method="POST" role="form text-left">
                    ...
                    <div class="form-group">
                        ...
                        <div class="@error('user.role') border border-danger rounded-3 @enderror">
                            <input disabled class="form-control" type="text" placeholder="Role" id="role" name="role" value="{{ auth()->user()->role }}">
                        </div>
                    </div>
                    <div class="d-flex justify-content-end">
                        <button type="submit" class="btn btn-md mt-4 mb-4" style="background-color: #2A4C09; color: white" >{{ 'Save Changes' }}</button>
                    </div>
                </form>
